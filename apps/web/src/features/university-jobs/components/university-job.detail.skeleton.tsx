...
import UniversityJobDetailHeader from "../layout/university-job.detail.header";

interface UniversityJobDetailSkeletonProps {
	universityJobId: string;
}

export default function UniversityJobDetailSkeleton({
	universityJobId,
}: UniversityJobDetailSkeletonProps) {
	return (
		<MainLayout
			headers={[
