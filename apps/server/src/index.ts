...
async function startServerWithRetry(startPort = 4000, maxRetries = 10): Promise<void> {
	...
	throw new Error(`Failed to start server after trying ports ${startPort}-${startPort + maxRetries - 1}`);
}
